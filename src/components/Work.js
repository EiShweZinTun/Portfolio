  ...
  return (
    <div id='work'>
      <div className='grid lg:grid-cols-2 grid-cols-1'>
        <div className='px-20 text-gray-600 text-center text-sm lg:text-base lg:text-left'>
       <h3 className='lg:text-2xl text-blue-700 mb-5 text-xl'>Full-Stack Developer</h3>
       ...
       <p>
        ...
        <div className='px-20 text-gray-600 text-center text-sm lg:text-left lg:text-base'>
        <div className='bg-about bg-contain bg-no-repeat mix-blend-lighten bg-top mb-20 mt-10'>
            <img src={design} />
        </div>
        <h3 className='text-xl lg:text-2xl text-blue-700 mb-5'>Web Designer</h3>
